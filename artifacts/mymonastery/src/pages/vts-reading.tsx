...
export default function VtsReadingPage() {
  ...
  // Leaf backdrop, matching Simple Guided Prayer / Contemplation / the office's
  // own reader pages. (Flamingos were tried here and reverted — owner. The
  // flamingo stays the commentary's mark on its card and its notification; the
  // reading itself sits on leaves like every other reader.)
