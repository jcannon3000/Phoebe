...
export default function MenuPage() {
  ...
  groups.push({
    ...
    items: [
      ...
      { emoji: "🌅", label: t("menu.newsletters", { defaultValue: "Newsletters" }), sub: t("menu.newsletters_sub", { defaultValue: "Daily words and weekly letters" }), onClick: () => go("/menu/newsletters") },
