...
export default function LetterInvitePage() {
  ...
  if (notFound) {
    return (
      <div className="min-h-screen flex items-center justify-center px-6 text-center" style={{ background: "#F5F0E8" }}>
        <div>
  ...
  return (
    <div className="min-h-screen flex flex-col items-center justify-center px-6 py-12" style={{ background: "#F5F0E8" }}>
