              ...
              {results.map((prayer) => {
                ...
                return (
                  <button
                    ...
                    style={{ background: "rgba(9,26,16, 0.297)", backdropFilter: "blur(11.34px)", WebkitBackdropFilter: "blur(11.34px)", border: "1px solid rgba(46,107,64,0.18)" }}
                  >
              ...
              return (
                <div key={category}>
                  <button
                    ...
                    style={{
                      background: isOpen ? "rgba(46,107,64,0.32)" : "rgba(9,26,16, 0.297)",
                      backdropFilter: "blur(11.34px)",
                      WebkitBackdropFilter: "blur(11.34px)",
