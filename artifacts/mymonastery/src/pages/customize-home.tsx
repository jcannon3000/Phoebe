...
function useModuleMeta(): Record<HomeModule, { label: string; emoji: string; sub: string }> {
  ...
  return {
    ...
    andrews:      { label: t("rhythm.card_andrews", { defaultValue: "Andrew's Version" }), emoji: "📰", sub: t("customize_home.andrews_sub", { defaultValue: "A weekly lectionary commentary from Yale Divinity School — it waits until you read it" }) },
