                ...
                <>
                  ...
                  >
                    ...
                    {/* Report — App Store Guideline 1.2 path. Sits
                        ...
                        report). Navigates to a dedicated page rather
                        than a popup so the form has full screen room
                        for the keyboard without the action buttons
                        landing under it. */}
                    {(person as any).userId && (
                      <button
                        onClick={() => {
                          setShowSettingsPopup(false);
                          setLocation(`/people/${encodeURIComponent(email ?? "")}/report`);
                        }}
                        className="w-full text-left px-4 py-2.5 text-sm transition-colors hover:bg-white/5"
