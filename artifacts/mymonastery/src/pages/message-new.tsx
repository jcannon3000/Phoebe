  ...
  return (
    <Layout>
      <div className="max-w-2xl mx-auto w-full pb-24">
        <Link href="/messages" className="text-sm inline-block mb-3" style={{ color: SAGE }}>← {t("messages.title")}</Link>
        <h1 className="text-2xl font-bold mb-4" style={{ color: WARM, fontFamily: FONT }}>{t("messages.new_title")}</h1>
        ...
        {isLoading ? (
          ...
          <p className="text-sm text-center py-10" style={{ color: SAGE }}>
            {all.length === 0 ? t("messages.no_beta_users") : t("messages.no_search_match")}
          </p>
        ) : (
