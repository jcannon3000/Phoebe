        ...
        <div className="flex flex-col items-center text-center pt-8">
          ...
          <div className="w-full" style={{ maxWidth: 440 }}>
            ...
            <div className="w-full flex items-center justify-between rounded-xl px-4 py-3 mb-2"
              style={{ background: "rgba(9,26,16,0.27)", backdropFilter: "blur(12.6px)", WebkitBackdropFilter: "blur(12.6px)", border: "1px solid rgba(46,107,64,0.32)" }}>
            ...
            <button
              ...
              style={{ background: "rgba(9,26,16,0.27)", backdropFilter: "blur(12.6px)", WebkitBackdropFilter: "blur(12.6px)", border: "1px solid rgba(168,197,160,0.45)", color: WARM, fontFamily: SPACE_GROTESK, fontSize: 17, fontWeight: 700, cursor: "pointer" }}
            >
