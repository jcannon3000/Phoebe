...
export default function Dashboard({ eventsOnly = false }: { eventsOnly?: boolean } = {}) {
  ...
  const HOME_MODULES = ["office", "feeds", "contemplation", "listening", "reading", "walk", "cobreathe", "compline", "prayer-list", "examen", "visio", "taize", "chittister", "cathedral", "cac", "fdd", "ssje", "vts", "nouwen", "sojo", "grist", "ncmp", "podcasts", "requests"] as const;
