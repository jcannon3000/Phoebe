...
export default function OfficePrayAlongPage() {
  ...
  return (
    <div style={{ position: "relative", minHeight: "var(--app-dvh)", background: BG, color: WARM, fontFamily: FONT, display: "flex", flexDirection: "column" }}>
      ...
      {/* Podcast bar */}
      <footer style={{ position: "relative", zIndex: 1, padding: "10px 20px max(1.1rem, calc(env(safe-area-inset-bottom) + 0.6rem))", borderTop: "1px solid rgba(46,107,64,0.25)", background: "rgba(9,26,16, 0.605)", backdropFilter: "blur(6px)", WebkitBackdropFilter: "blur(6px)" }}>
