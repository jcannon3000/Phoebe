      ...
      <div className="space-y-2.5">
        ...
        <div className="relative w-full">
          <div className="w-full rounded-full flex items-center justify-between"
            style={{ background: "rgba(9,26,16,0.27)", backdropFilter: "blur(12.6px)", WebkitBackdropFilter: "blur(12.6px)", border: "1px solid rgba(46,107,64,0.4)", padding: "15px 20px", gap: 12, pointerEvents: "none" }}>
