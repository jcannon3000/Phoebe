          ...
          <>
            ...
            <div className="grid grid-cols-2 gap-2">
              {([
                ...
                { type: "cobreathe" as SessionType, emoji: "🌍", label: t("contsetup.cobreathe", { defaultValue: "Breathing Together" }), sub: t("contsetup.cobreathe_sub", { defaultValue: "Breathing together with God's creation" }), rgb: GREEN },
              ]).map((o) => {
