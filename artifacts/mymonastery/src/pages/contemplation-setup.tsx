          ...
          <>
            ...
            <div className="grid grid-cols-2 gap-2">
              {([
                ...
                { type: "cobreathe" as SessionType, emoji: "🌍", label: t("contsetup.cobreathe", { defaultValue: "Creation Prayer" }), sub: t("contsetup.cobreathe_sub", { defaultValue: "Breathe together" }), rgb: GREEN },
              ]).map((o) => {
