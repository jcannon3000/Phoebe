    ...
    >
      <div className="flex items-center gap-4">
        ...
        <div className="flex-1">
          ...
          <p className="text-sm mt-0.5" style={{ color: "#8FAF96" }}>The creation Psalter &amp; prayers, with Breathing Together</p>
      ...
      <div className="flex flex-col w-full max-w-2xl mx-auto pb-24">
        <div className="mb-6">
          ...
          <p className="text-sm" style={{ color: "#8FAF96" }}>
            A creation-focused devotion — a two-week cycle of the Psalms with prayers for creation, and the Breathing Together breath woven in at the intercession
          </p>
        </div>
