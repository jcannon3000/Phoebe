...
import { WAY_OF_LOVE_VIDEOS, SERIES_TITLE, wistiaEmbedUrl } from "@/lib/wayOfLoveVideos";
                ...
                <div style={{ position: "relative", width: "100%", paddingTop: "56.25%", borderRadius: 16, overflow: "hidden", border: `1px solid ${CARD_B}`, background: "#000" }}>
                  {playing ? (
                    ...
                    >
                      ...
                      <span style={{ display: "flex", alignItems: "center", justifyContent: "center", width: 52, height: 52, borderRadius: 999, background: "rgba(240,237,230,0.16)", border: "1px solid rgba(240,237,230,0.4)" }}>
