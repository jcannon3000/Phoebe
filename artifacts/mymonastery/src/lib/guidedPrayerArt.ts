...
export const GUIDED_PRAYER_ART: Record<1 | 2 | 3 | 4, GuidedPrayerArt[]> = {
  ...
  3: [
    ...
    { id: 48272, ratio: 1.48 }, // JESUS MAFA, The Lord's Supper
    { id: 55893, ratio: 0.75 }, // Reid, Multiplication of the Loaves and Fishes (detail)
    { id: 54414, ratio: 1.309 }, // Latimore, La presentación de Cristo en el templo — Simeon and Anna
