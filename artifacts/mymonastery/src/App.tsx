...
class ErrorBoundary extends Component<{ children: ReactNode }, { error: Error | null }> {
  ...
  render() {
    if (this.state.error) {
      return (
        <div style={{ padding: 24, fontFamily: "monospace", background: "#EDE0C4", minHeight: "100vh" }}>
          ...
          <button
            ...
            style={{ marginTop: 16, padding: "8px 20px", background: "#2C1810", color: "#F5ECDA", border: "none", borderRadius: 8, cursor: "pointer" }}
          >
            Back to dashboard
          </button>
        </div>
