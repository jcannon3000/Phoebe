...
const CommunityPrayerListPage = lazy(() => import("./pages/community-prayer-list"));
...
const DailyPrayerCoursePage = lazy(() => import("@/pages/daily-prayer-course"));
...
const CacHomePage = lazy(() => import("./pages/cac-home"));
...
const PERSISTED_QUERY_KEYS = [
  ...
  "/api/me/garden-week",
  "/api/cac/today-meta",
  // The app-open splash's "prayed for you this month" — persisted so the splash
  // renders INSTANTLY from the last session (cached, no lag/flash) and
  // refreshes in the background. (/api/me/practice-week was persisted beside it
  // for the weekly grid; that grid is retired and nothing fetches the route.)
...
const GUEST_ALLOWED_EXACT = new Set<string>([
  ...
  "/reflect/cac", "/listening", "/lectio", "/walk-log", "/reading-log", "/podcast-log",
  /**
...
function Router() {
  return (
    ...
    <Switch>
      ...
      {/* The eight-day sermon course — a demo, admins only (see the page). */}
      <Route path="/daily-prayer-course" component={DailyPrayerCoursePage} />
      ...
      <Route path="/communities/:slug/prayer-list" component={CommunityPrayerListPage} />
      ...
      <Route path="/cac-show/:slug" component={CacShowPage} />
