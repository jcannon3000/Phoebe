...
const GUEST_ALLOWED_EXACT = new Set<string>([
  ...
  // generic show page; the Courses menu is guest-visible, so its target must
  // be too or the tap bounces to the dashboard (it did, on first deploy).
  "/podcasts/show/roundtables-on-race",
