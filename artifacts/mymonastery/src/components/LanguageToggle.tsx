...
export function LanguageToggle() {
  ...
  return (
    <div
      ...
      style={{ background: "rgba(9,26,16,0.27)", backdropFilter: "blur(12.6px)", WebkitBackdropFilter: "blur(12.6px)", border: "1px solid rgba(200,212,192,0.18)", opacity: save.isPending ? 0.6 : 1 }}
    >
      {opt("es", "ES")}
