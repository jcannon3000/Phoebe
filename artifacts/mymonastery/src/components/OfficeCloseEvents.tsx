      ...
      <div className="flex flex-col gap-2.5 text-left">
        ...
        {isBeta && (
          <motion.button
            ...
            style={{ background: "rgba(9,26,16, 0.297)", backdropFilter: "blur(11.34px)", WebkitBackdropFilter: "blur(11.34px)", border: "1px solid rgba(200,212,192,0.28)", color: "#F0EDE6", fontFamily: SPACE_GROTESK, fontSize: 14.5, fontWeight: 600, padding: "13px 16px", cursor: "pointer" }}
          >
