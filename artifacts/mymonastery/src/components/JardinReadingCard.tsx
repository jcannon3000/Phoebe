...
export function JardinReadingCard() {
  ...
  return (
    <div className="rounded-2xl overflow-hidden flex" style={{ background: "rgba(9,26,16, 0.297)", backdropFilter: "blur(11.34px)", WebkitBackdropFilter: "blur(11.34px)", border: "1px solid rgba(200,212,192,0.18)" }}>
