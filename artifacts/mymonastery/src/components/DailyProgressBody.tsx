...
function StreakCard() {
  ...
  return (
    <div
      ...
      style={{ background: `linear-gradient(180deg, rgba(${GREEN},0.09) 0%, rgba(${GREEN},0.17) 100%)`, border: `1px solid rgba(${GREEN},0.26)` }}
    >
...
function PracticeCard({
  ...
  if (hero) {
    ...
    const heroRow = (
      <div
        ...
        style={{ background: `linear-gradient(180deg, rgba(${rgb},0.24) 0%, rgba(${rgb},0.39) 100%)`, border: `1px solid rgba(${rgb},0.46)`, opacity: waiting ? 0.8 : 1 }}
      >
  ...
  const row = (
    <motion.div
      ...
      style={{ background: `linear-gradient(180deg, rgba(${rgb},0.22) 0%, rgba(${rgb},0.35) 100%)`, border: `1px solid ${restBorder}`, opacity: waiting ? 0.72 : 1 }}
