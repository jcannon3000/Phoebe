...
// Open fifth: A2 + E3 + A3. Each voice gets a relative gain matching
// the in-app version so the chord balance reads the same.
const VOICES = [
...
// Sample data (Int16Array → little-endian bytes)
for (let i = 0; i < samples.length; i++) {
  buf.writeInt16LE(samples[i], 44 + i * 2);
}

const dest = resolve(process.cwd(), "ios/App/App/PhoebeRising.caf");
