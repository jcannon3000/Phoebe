...
// The Google-Calendar Daily Bell (a recurring invite the user accepted, its
// discovery scan, and RSVP/attendee polling — findActiveBellEventForUser,
// getCalendarEventAttendees) was removed entirely (owner). The push-based
// bell (bellSender.ts) is unrelated and unaffected.
