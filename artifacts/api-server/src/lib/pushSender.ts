...
// Custom notification sound bundled in the iOS app
// (phoebe-mobile/ios/App/App/PhoebeRising.caf — generated by
// scripts/build-rising-sound.mjs). The synthesized "rising swell" the
// slideshow opens with, compressed to ~2.4s. iOS plays the file by
// name from the app bundle root; if the file is missing on a build
// (e.g. someone forgot to bundle it after pulling), iOS silently falls
// back to the system default chime — no error, no crash, just no
// custom tone. Older builds installed before the file was added will
// also fall back automatically.
const PHOEBE_SOUND = "PhoebeRising.caf";
