...
const SECTIONS = new Set(["turn", "learn_pray", "learn", "pray", "worship", "bless", "go", "rest", "weekly_review", "gratitude", "examen", "listening", "journaling", "lectio", "reading", "podcasts", "walk", "prayer-list"]);
