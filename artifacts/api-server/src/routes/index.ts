...
import rhythmPartyRouter from "./rhythm-party";
...
import reflectionThoughtsRouter from "./reflection-thoughts";
...
import scriptureAlignmentRouter from "./scripture-alignment";
...
import lectioLogRouter from "./lectio-log";
...
router.use(reflectionThoughtsRouter);
