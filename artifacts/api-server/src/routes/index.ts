...
import actOverridesRouter from "./act-overrides";
import ministriesRouter from "./ministries";
import cacRouter from "./cac";
import vtsRouter from "./vts";
import nouwenRouter from "./nouwen";
import gristRouter from "./grist";
import sojoRouter from "./sojo";
import vcsRouter from "./vcs";
import cacLibraryRouter from "./cac-library";
import taizeRouter from "./taize";
import groupReflectionsRouter from "./group-reflections";
import inboundEmailRouter from "./inbound-email";
import groupPrayerListRouter from "./group-prayer-list";
import weeklyReadingsRouter from "./weeklyReadings";
import lectionaryRouter from "./lectionary";
import scriptureRouter from "./scripture";
import ncmpRouter from "./ncmp";
import taizePrayerRouter from "./taize-prayer";
import courseRelayRouter from "./course-relay";
...
import novenasRouter from "./novenas";
import breathRouter from "./breath";
import listeningRouter from "./listening";
import appleMusicRouter from "./apple-music";
import spotifyCatalogRouter from "./spotify-catalog";
import curatedAudioRouter from "./curated-audio";
...
router.use(actOverridesRouter);
router.use(ministriesRouter);
router.use(cacRouter);
router.use(vtsRouter);
router.use(nouwenRouter);
router.use(gristRouter);
router.use(sojoRouter);
router.use(vcsRouter);
router.use(cacLibraryRouter);
router.use(taizeRouter);
router.use(groupReflectionsRouter);
router.use(inboundEmailRouter);
router.use(groupPrayerListRouter);
router.use(weeklyReadingsRouter);
router.use(lectionaryRouter);
router.use(scriptureRouter);
router.use(ncmpRouter);
router.use(taizePrayerRouter);
router.use(courseRelayRouter);
...
router.use(novenasRouter);
router.use(breathRouter);
router.use(listeningRouter);
router.use(appleMusicRouter);
router.use(spotifyCatalogRouter);
router.use(curatedAudioRouter);
